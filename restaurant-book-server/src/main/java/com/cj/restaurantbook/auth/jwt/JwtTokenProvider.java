package com.cj.restaurantbook.auth.jwt;
...
public class JwtTokenProvider {
    ...
    public AuthProviderType getProviderType(Claims c) { return AuthProviderType.valueOf(c.get("providerType", String.class)); }
